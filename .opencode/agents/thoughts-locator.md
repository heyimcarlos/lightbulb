---
description: Finds relevant documents in thoughts directories and reports their locations without deep analysis.
mode: subagent
color: secondary
permission:
  "*": deny
...
1. **Search thoughts/ directory structure**
   ...
   - Check user-specific thoughts directories for personal notes
