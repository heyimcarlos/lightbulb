...
The inherited GitHub installer is disabled in Lightbulb.

```bash
opencode github install # disabled in Lightbulb
```

Lightbulb needs a native action, app, and trigger vocabulary before this command can provide setup steps. [Learn more](/docs/github).

---

#### run

The inherited GitHub runner is disabled in Lightbulb.

```bash
opencode github run # disabled in Lightbulb
```

Lightbulb needs a native action, app, and trigger vocabulary before this command can run repository automation. [Learn more](/docs/github).
